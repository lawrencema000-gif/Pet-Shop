      ...
      <AnimatePresence>
        {isOpen && hasResults && (
          <motion.div
            ...
            className="absolute top-full left-0 right-0 mt-2 bg-background border border-border rounded-md shadow-sm z-50 overflow-hidden max-h-[400px] overflow-y-auto"
          >
            {/* Products section */}
            {products.length > 0 && (
              <div>
